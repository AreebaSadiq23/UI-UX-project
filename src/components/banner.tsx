    ...
    <div className="w-full flex justify-center items-center mt-10 mb-1 max-w-screen-2xl mx-auto">
      <div className="sm:-end-full md:w-[80%] sm:p-5 md:pl-5 bg-black sm:h-[100%] md:h-[400px] flex sm:flex-col md:flex-row sm:justify-start  md:justify-center sm:items-start md:items-center">
        <div className="sm:w-[100%] md:w-[50%]">
          ...
          <h1 className="text-white font-bold sm:text-md md:text-2xl lg:text-6xl pt-4">
        ...
        <div className="sm:w-[80%] md:[40%] lg:w-[40%] pl-6">
          <Image
            ...
            alt="images"
          ></Image>
          <button className="bg-green-500 hover:bg-green-400  sm:block md:hidden  sm:px-3 md:px-7 sm:text-sm md:text-sm py-0 text-white font-bold rounded-sm h-10 mt-3  ">
            Buy Now!
          </button>
        </div>
      </div>
